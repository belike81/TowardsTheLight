...
namespace EscalatorPro
{
    public class Stair : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if ( escalator.reversed ) ReverseDirection();
        ...
        private void FixedUpdate()
        {
            ...
            var calculatedPos = transform.parent.TransformPoint( Vector3.MoveTowards( body.transform.localPosition,
                targetPos, escalator.speed * Time.deltaTime * 3 ) );
        ...
        private void HandleVisibility()
        {
            if ( !escalator.reversed ) {
                ...
                if ( nextDestination == EscalatorPro.Destination.ToStartPointDown ||
                     nextDestination == EscalatorPro.Destination.ToStartPoint ) {
                    if ( escalator.disableMesh && mesh )
                        mesh.enabled = true;
